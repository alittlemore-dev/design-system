...
export class ErrorMessageComponent {
  ...
  /** @internal */
  protected readonly nestedMessages = computed(() => flattenNestedErrorMessages(this.error()));

  /** @internal */
  protected readonly topLevelMessage = computed(() => formatErrorMessage(this.error()));
}
