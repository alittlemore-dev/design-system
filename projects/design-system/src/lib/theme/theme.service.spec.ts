...
describe('ThemeService', () => {
  ...
  beforeEach(() => {
    localStorage.clear();
    globalThis.document.documentElement.setAttribute('data-bs-theme', 'light');
  ...
  it('preserves a valid theme already rendered on the document', () => {
  ...
  it('falls back to the rendered theme when browser storage cannot be read', () => {
    document.documentElement.setAttribute('data-bs-theme', 'dark');
    jest.spyOn(Storage.prototype, 'getItem').mockImplementation(() => {
      throw new Error('localStorage reads are blocked');
    });
    TestBed.resetTestingModule();
    TestBed.configureTestingModule({});
  ...
  it('still applies a selected theme when browser storage cannot be written', () => {
    jest.spyOn(Storage.prototype, 'setItem').mockImplementation(() => {
      throw new Error('localStorage writes are blocked');
    });
