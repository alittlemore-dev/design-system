...
@Component({
  selector: 'ds-markdown-editor-sticky-bottom-inset-test-host',
  standalone: true,
  ...
  template: `
    @if (firstVisible()) {
      <form #firstForm data-testid="first-form">
        ...
        <footer data-testid="first-footer" [dsMarkdownEditorStickyBottomInset]="firstForm">
    ...
    @if (secondVisible()) {
      <form #secondForm data-testid="second-form">
        ...
        <footer data-testid="second-footer" [dsMarkdownEditorStickyBottomInset]="secondForm">
          Actions
        </footer>
      </form>
    }
...
@Component({
  selector: 'ds-markdown-editor-sticky-bottom-inset-foreign-scope-test-host',
  standalone: true,
  imports: [MarkdownEditorStickyBottomInsetDirective],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <footer data-testid="foreign-scope-footer" [dsMarkdownEditorStickyBottomInset]="foreignScope">
      Actions
    </footer>
  `,
})
